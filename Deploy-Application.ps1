...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Copy-File -Path "$dirFiles\GeoGebra" -Destination "$envProgramFilesX86\" -Recurse
		...
		Copy-File -Path "$dirSupportFiles\GeoGebra.lnk" -Destination "$envCommonDesktop"
